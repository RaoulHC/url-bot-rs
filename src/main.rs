...
mod tests {
    ...
    fn test_utf8_truncate() {
        ...
        assert_eq!(" ", utf8_truncate("  ", 1));
        assert_eq!("♥", utf8_truncate("♥", 4));
        assert_eq!("♥", utf8_truncate("♥", 3));
        assert_eq!("", utf8_truncate("♥", 2));
        assert_eq!("\u{0306}", utf8_truncate("\u{0306}", 2));
        assert_eq!("", utf8_truncate("\u{0306}", 1));
        assert_eq!("hello ", utf8_truncate("hello 😃 world!", 6));
        assert_eq!("hello ", utf8_truncate("hello 😃 world!", 7));
        assert_eq!("hello ", utf8_truncate("hello 😃 world!", 8));
        assert_eq!("hello ", utf8_truncate("hello 😃 world!", 9));
        assert_eq!("hello 😃", utf8_truncate("hello 😃 world!", 10));
        assert_eq!("hello 😃 ", utf8_truncate("hello 😃 world!", 11));
        assert_eq!("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X♬",
            utf8_truncate("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X♬", 48));
        assert_eq!("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X♬",
            utf8_truncate("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X♬", 45));
        assert_eq!("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X",
            utf8_truncate("ǫɀŤ-¢R☮*œ♊ťC(Ň🙈5R)😻ȭ♳X♬", 42));
    }
}
